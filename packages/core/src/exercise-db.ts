...
export const GYM_EXERCISES: GymExercise[] = [
  ...
  E("Dip", "Chest", "push-v", ["chest", "triceps"], ["front-delts"], "bodyweight", null, BWPLUS),
  ...
  E("Pull-Up", "Back", "pull-v", ["lats"], ["biceps", "upper-back", "forearms"], "bodyweight", null, BWPLUS),
  E("Chin-Up", "Back", "pull-v", ["lats", "biceps"], ["upper-back", "forearms"], "bodyweight", null, BWPLUS),
  ...
  E("Muscle-Up", "Back", "pull-v", ["lats", "chest"], ["biceps", "triceps", "abs"], "bodyweight", null, BWPLUS),
  ...
  E("Back Extension", "Back", "hinge", ["lower-back", "glutes"], ["hamstrings"], "bodyweight", null, BWPLUS),
  ...
  E("Pistol Squat", "Quads & Glutes", "squat", ["quads", "glutes"], ["abs"], "bodyweight", null, { ...UNI, ...BWPLUS }),
  ...
  E("Glute Bridge", "Hamstrings & Glutes", "hinge", ["glutes"], ["hamstrings"], "bodyweight", null, BWPLUS),
  ...
  E("Glute-Ham Raise", "Hamstrings & Glutes", "isolation", ["hamstrings", "glutes"], ["lower-back"], "bodyweight", null, { ...ISO, ...BWPLUS }),
  ...
  E("Single-Leg Calf Raise", "Calves", "isolation", ["calves"], [], "bodyweight", null, { ...ISO, ...UNI, ...BWPLUS }),
  ...
  E("Bench Dip", "Triceps", "push-v", ["triceps"], ["chest", "front-delts"], "bodyweight", null, BWPLUS),
