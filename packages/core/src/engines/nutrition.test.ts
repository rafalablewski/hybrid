...
import { dailyNutrition, todayNutrition, estimateMaintenance, adaptiveTargets, nutritionSummary, nutritionNudge, sumMealComponents, resolveMealParts, mealPartKey, MAX_CUSTOM_MEAL_PARTS } from "./nutrition";
