...
const KB_WEEKS: KBDay[][] = [
  ...
  [
    { day: "Mon", focus: "Push", items: [
      ...
      ["Kettlebell Dips", "3 × 15"],
    ] },
    { day: "Tue", focus: "Pull", items: [
      ["Kettlebell Deadlift", "3 × 20"],
  ...
  [
    ...
    { day: "Tue", focus: "Pull", items: [
      ...
      ["Gorilla Row", "4 × 12"],
      ["Kettlebell High Pull", "4 × 12"],
      ["Dual-arm Russian Swing", "4 × 25"],
      ["Kettlebell Curl", "4 × 15"],
    ] },
    { day: "Thu", focus: "Lower", items: [
      ["Front Squat", "4 × 20"],
