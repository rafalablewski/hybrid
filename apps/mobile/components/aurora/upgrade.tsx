...
export default function AuroraUpgrade() {
  ...
  return (
    ...
    <Sheet visible={open} onClose={close} onClosed={() => router.back()}>
      ...
      <Text style={{ fontFamily: F.takeover, fontSize: fs.display, letterSpacing: tracking(fs.display), color: C.chalk, textAlign: "center", marginTop: 16 }}>{t("w.account.upgrade.sheet-title")}</Text>
      ...
      <View style={{ alignItems: "center", marginTop: 16 }}>
        <Text style={{ fontFamily: F.takeover, fontSize: 28, letterSpacing: tracking(28), color: C.chalk }}>
