...
export const CAPABILITIES: Capability[] = [
  ...
  { id: "athlete-twin", area: "Data", status: "shipped", title: "Athlete Digital Twin + Performance State", detail: "computePerformanceState fuses HPI + readiness + fatigue into one object WITH ranked 'why did it move' drivers (load + recovery attribution) and a one-line summary. Surfaced as the web dashboard Performance State cockpit + mobile Home. Next depth: persisted Signal ingestion + nightly materialization/caching + trajectory over history." },
