...
export default function AuroraVolume({ sessions, unified = false, compact = false, onOpenModel }: {
  ...
  // THE DRAWER, and the sheet the provenance is dispatched to.
  ...
  // it, on the screen and in the card alike (audit/10, render cost).
  ...
  // the drawer would shut on nothing.
  ...
  const detail = (flat: boolean) => (
    <>
      ...
      <SourceDoor flat={flat} onOpen={openSource} />
    </>
  );
