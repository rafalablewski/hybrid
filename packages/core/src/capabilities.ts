...
export const CAPABILITIES: Capability[] = [
  ...
  // ---- Mobile ----
  { id: "mobile-app", area: "Mobile", status: "shipped", title: "Native app (code)", detail: "Expo app: Supabase auth + tab navigator (Home/Plans/Sport/Log/Velocity/History/Coach) on the same core and the same /api backend. The Velocity (VBT) tab mirrors web — estimated 1RM from velocity, a dependency-free load–velocity plot, velocity zones, recent sets and the 'AI load' bar-speed recommender — and the Log tab captures an m/s column per set, feeding the velocity-aware prescription. iOS bundle verified." },
