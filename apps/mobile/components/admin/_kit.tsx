...
export function ErrorNote({ error, onDismiss }: { error: string | null; onDismiss?: () => void }) {
  ...
  return (
    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: space.ms, borderLeftWidth: 3, borderLeftColor: palette.amber, backgroundColor: withAlpha(palette.amber, 0.08), borderRadius: 8, padding: 10, marginBottom: 12 }}>
