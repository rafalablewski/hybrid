...
export default function Sheet({
  ...
  const header = (
    <>
      <View style={{ width: 40, height: 4, borderRadius: RADIUS.pill, backgroundColor: C.line, alignSelf: "center", marginBottom: title || sub ? 16 : 8 }} />
      {title ? <Text style={{ fontFamily: F.black, fontSize: fs.headline, letterSpacing: tracking(fs.headline), color: C.chalk }}>{title}</Text> : null}
