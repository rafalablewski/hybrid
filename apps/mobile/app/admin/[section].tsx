    ...
    <Screen>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 16 }}>
        <Pressable
          ...
          hitSlop={10}
          style={{ width: 38, height: 38, borderRadius: 10, borderWidth: 1, borderColor: palette.line, backgroundColor: palette.ink2, alignItems: "center", justifyContent: "center" }}
        >
          <Text style={{ color: palette.chalk, fontSize: 18 }}>‹</Text>
        </Pressable>
        <View style={{ flex: 1 }}>
