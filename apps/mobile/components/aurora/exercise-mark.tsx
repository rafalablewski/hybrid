 ...
 * from the shared @hybrid/core path data at the shared
 * `auroraIconStroke(size)` weight, so it matches web exactly and sits at the
 * same optical weight as the rest of the Aurora icon set.
 *
