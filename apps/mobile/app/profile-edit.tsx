  ...
  return (
    <Screen>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 16 }}>
        ...
        <View>
          <Text style={{ color: C.chalk, fontFamily: F.bold, fontWeight: "800", fontSize: 24 }}>Public profile</Text>
          <Text style={{ color: C.ash, fontSize: 13 }}>Handle, bio, photo and privacy.</Text>
        </View>
      </View>
