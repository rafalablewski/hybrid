...
export default function AuroraVelocity() {
  ...
  return (
    <AuroraScreen hero={{ rank: "title", title: t("w.analyze.vel.title") }} refreshing={refreshing} onRefresh={load}>
      ...
      <ACard style={{ marginTop: 16 }}>
        <Text style={{ fontFamily: F.mono, fontSize: fs.micro, textTransform: "uppercase", letterSpacing: tracking(fs.micro, "caps"), color: txt(C, C.lime) }}>{t("w.analyze.vel.profile")} – {active}</Text>
      ...
      <ACard style={{ marginTop: 16 }}>
        <Text style={{ fontFamily: F.mono, fontSize: fs.micro, textTransform: "uppercase", letterSpacing: tracking(fs.micro, "caps"), color: C.ash }}>{t("w.analyze.vel.aiLoad")}</Text>
      ...
      <ACard style={{ marginTop: 16 }}>
        <Text style={{ fontFamily: F.mono, fontSize: fs.micro, textTransform: "uppercase", letterSpacing: tracking(fs.micro, "caps"), color: C.ash }}>{t("w.analyze.vel.zones")}</Text>
      ...
      <ACard style={{ marginTop: 16 }}>
        <Text style={{ fontFamily: F.mono, fontSize: fs.micro, textTransform: "uppercase", letterSpacing: tracking(fs.micro, "caps"), color: txt(C, C.lime) }}>{t("w.analyze.vel.recentSets")}</Text>
        <View style={{ marginTop: 8 }}>
