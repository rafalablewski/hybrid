              ...
              {clients.map((c) => {
                ...
                return (
                  <Pressable
                    ...
                    style={{ borderWidth: 1, borderColor: on ? C.lime : C.line, backgroundColor: on ? `${C.lime}1c` : "transparent", borderRadius: RADIUS.pill, paddingHorizontal: 10, paddingVertical: 6 }}
                  >
