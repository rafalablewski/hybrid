      ...
      {hasEnduranceHistory(sessions) && (
        <>
          ...
          {/* ───── (a) THE STRIP — the section's opener, and deliberately
              SMALL: efforts / distance / time for the period, each against its
              own baseline, and nothing else. It carries no filter (it reads the
              screen's period, which the verdict card's control writes) and no
              per-discipline breakdown — that breakdown is the lanes directly
              below, and printing it here was a table of contents that pushed
              its own contents off the screen. The figures are a SLICE of the
