...
export const GOAL_TREE: GoalNode[] = [
  ...
  { id: "fatloss", name: "Fat Loss", icon: "◐", color: AMBER, category: "Physique", blurb: "Drop fat and keep the muscle. Train hard, recover smart, recomp the right way.",
    plans: [
      { id: "fatloss-4day", name: "4-Day Upper / Lower", weeks: 10, sessions: 4, tag: "Upper/Lower", desc: "The recommended pick. Lift heavy to keep your muscle in a deficit, with a short conditioning finisher each session to burn more.", focus: ["Strength", "Conditioning"], hot: true },
      { id: "fatloss-3day", name: "3-Day Full Body", weeks: 8, sessions: 3, tag: "Full Body", desc: "The time-efficient option. Full-body strength three times a week plus intervals — hold onto muscle while the fat comes off.", focus: ["Strength", "Conditioning"] },
      { id: "fatloss-5day", name: "5-Day Split + Conditioning", weeks: 8, sessions: 5, tag: "5 Days", desc: "Push/Pull/Legs, an upper pump day, and a dedicated conditioning + core day for the highest weekly burn.", focus: ["Hypertrophy", "Conditioning"], hot: true },
    ] },
  // ---- Endurance ----
...
export const PLAN_DETAIL: Record<string, PlanDetail> = {
  ...
  // loads stay heavy (RPE 8 on the big lifts) while rest is short to raise
  // density. Each session ends with a conditioning finisher — intervals or a
  // steady incline walk (Intensity column: RPE 9 for intervals, 6 for steady).
  "fatloss-3day": {
    level: "Beginner–Intermediate",
    forWho: "Anyone in a calorie deficit training 3 days/week who wants to lose fat without losing the muscle underneath.",
    outcome: "Visible fat loss with strength and muscle retained — full-body lifting three times a week plus conditioning to widen the burn.",
    sessionLength: "55–70 min",
    equipment: "Full gym (barbell, dumbbells, cables, machines, a bike/rower/treadmill)",
    split: ["Day A", "Rest", "Day B", "Rest", "Day C", "Rest", "Rest"],
    days: [
      { day: "Day A", items: [
        { name: "Goblet Squat", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Bench Press", sr: "3 × 10", rest: "1:30", rpe: "8" },
        { name: "Lat Pulldown", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Dumbbell Romanian Deadlift", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Lateral Raise", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Plank", sr: "3 × 45 sec", rest: "1:00", rpe: "—" },
        { name: "Bike Intervals (finisher)", sr: "8 × 30 sec", rest: "1:00", rpe: "9" },
      ] },
      { day: "Day B", items: [
        { name: "Back Squat", sr: "3 × 8", rest: "2:00", rpe: "8" },
        { name: "Overhead Press", sr: "3 × 10", rest: "1:30", rpe: "8" },
        { name: "Seated Cable Row", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Walking Lunge", sr: "3 × 12 / leg", rest: "1:30", rpe: "8" },
        { name: "Hanging Leg Raise", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Rower Intervals (finisher)", sr: "10 × 20 sec", rest: "0:40", rpe: "9" },
      ] },
      { day: "Day C", items: [
        { name: "Deadlift", sr: "3 × 6", rest: "2:30", rpe: "8" },
        { name: "Incline Dumbbell Press", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Assisted Pull-Up", sr: "3 × 10", rest: "1:30", rpe: "8" },
        { name: "Leg Press", sr: "3 × 15", rest: "1:30", rpe: "9" },
        { name: "Face Pull", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Incline Treadmill Walk (finisher)", sr: "1 × 20 min", rest: "—", rpe: "6" },
      ] },
    ],
    progression: "Nutrition does the fat loss — keep a moderate deficit and protein high; the lifting is here to hold onto muscle, so chase the SAME loads week to week rather than adding. Keep rest short (60–90 s) to raise density, and push the conditioning finishers hard. Aim for 8–10k steps on top. Deload or drop a session in any week your readiness tanks.",
  },
  "fatloss-4day": {
    level: "Intermediate",
    forWho: "Lifters in a deficit who can train 4 days/week and want each half of the body trained twice — the best all-round driver of a lean recomposition.",
    outcome: "Fat off, muscle and strength kept — two upper and two lower days that preserve the big lifts, each capped with conditioning.",
    sessionLength: "60–75 min",
    equipment: "Full gym (barbell, dumbbells, cables, machines, a bike/rower/treadmill)",
    split: ["Upper A", "Lower A", "Rest", "Upper B", "Lower B", "Rest", "Rest"],
    days: [
      { day: "Upper A", items: [
        { name: "Bench Press", sr: "4 × 8", rest: "2:00", rpe: "8" },
        { name: "Barbell Row", sr: "4 × 10", rest: "2:00", rpe: "8" },
        { name: "Overhead Press", sr: "3 × 10", rest: "1:30", rpe: "8" },
        { name: "Lat Pulldown", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Lateral Raise", sr: "3 × 15", rest: "1:00", rpe: "9" },
      ...
      { day: "Lower B", items: [
        ...
        { name: "Leg Press", sr: "4 × 15", rest: "1:30", rpe: "9" },
        { name: "Bulgarian Split Squat", sr: "3 × 12", rest: "1:30", rpe: "8" },
        { name: "Leg Extension", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Cable Crunch", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Incline Treadmill Walk (finisher)", sr: "1 × 20 min", rest: "—", rpe: "6" },
      ] },
    ],
    progression: "The deficit drives the fat loss; this split is here to defend your muscle and strength, so aim to MATCH last week's loads on the main lifts rather than push new PRs. Keep rest at 90–120 s on compounds and short on accessories to keep density high. Bank 8–10k daily steps plus the finishers for the bulk of the calorie burn. Deload every 6th week, or sooner if strength starts sliding.",
  },
  "fatloss-5day": {
    level: "Intermediate–Advanced",
    forWho: "Lifters who can train 5 days/week and want the highest weekly training burn while holding muscle in a deficit.",
    outcome: "Lean recomposition with high volume and frequency — a body-part split plus a dedicated conditioning day for maximum weekly energy out.",
    sessionLength: "60–75 min",
    equipment: "Full gym (barbell, dumbbells, cables, machines, kettlebell, a bike/rower/treadmill)",
    split: ["Push", "Pull", "Legs", "Upper Pump", "Conditioning", "Rest", "Rest"],
    days: [
      { day: "Push", items: [
        { name: "Bench Press", sr: "4 × 8", rest: "2:00", rpe: "8" },
        { name: "Overhead Press", sr: "3 × 10", rest: "1:30", rpe: "8" },
      ...
      { day: "Upper Pump", items: [
        { name: "Incline Dumbbell Press", sr: "4 × 12", rest: "1:30", rpe: "9" },
        { name: "Seated Cable Row", sr: "4 × 12", rest: "1:30", rpe: "8" },
        { name: "Cable Fly", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Rear Delt Fly", sr: "3 × 20", rest: "1:00", rpe: "9" },
        { name: "Hammer Curl", sr: "3 × 15", rest: "1:00", rpe: "9" },
        { name: "Overhead Triceps Extension", sr: "3 × 15", rest: "1:00", rpe: "9" },
      ] },
      { day: "Conditioning & Core", items: [
        { name: "Kettlebell Swing", sr: "5 × 15", rest: "1:00", rpe: "8" },
        { name: "Goblet Squat", sr: "3 × 15", rest: "1:00", rpe: "8" },
        { name: "Walking Lunge", sr: "3 × 20 / leg", rest: "1:00", rpe: "8" },
        { name: "Row / Bike Intervals", sr: "10 × 40 sec", rest: "0:50", rpe: "9" },
        { name: "Plank", sr: "3 × 60 sec", rest: "1:00", rpe: "—" },
        { name: "Incline Treadmill Walk", sr: "1 × 20 min", rest: "—", rpe: "6" },
      ] },
    ],
    progression: "With five sessions in a deficit, recovery is the limiter — keep the lifting loads steady (hold strength, don't chase PRs) and let the extra frequency and the conditioning day do the calorie work. Short rest on accessories keeps density high. Watch readiness closely: drop the Upper Pump or Conditioning day in any week sleep or stress spikes, and deload every 6th week.",
  },
};
