  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: C.ink }}>
      ...
      >
        ...
        {/* ───── (a) THIS WEEK — the verdict card, and the cluster's date
        ...
        {hasEnduranceHistory(sessions) && (
          <>
            ...
            {/* ───── (a) THIS WEEK — the section's own summary card and its own
                filter: efforts / distance / time for the period, each against
                its own baseline, then what the time was made of. The figures
                are a SLICE of the verdict card's above (core
